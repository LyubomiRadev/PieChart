...
public partial class MainWindow : Window
{
    public MainWindow()
    {
		...
		//pieSeries.Slices.Add(new PieSlice("Africa", 1030) { IsExploded = true, Fill = OxyColors.AliceBlue });
		//pieSeries.Slices.Add(new PieSlice("Americas", 929) { IsExploded = true, Fill = OxyColors.Beige });
		//pieSeries.Slices.Add(new PieSlice("Asia", 4157));
		//pieSeries.Slices.Add(new PieSlice("Europe", 739) { IsExploded = true, Fill = OxyColors.Red });
		//pieSeries.Slices.Add(new PieSlice("Oceania", 35) { IsExploded = true, Fill = OxyColors.Green });
